...
class Task(Base):
    ...
    tags: Mapped[str | None] = mapped_column(String(255), nullable=True, default="feature")
    estimated_hours: Mapped[float | None] = mapped_column(Float, nullable=True, default=4.0)
